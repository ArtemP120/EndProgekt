...
background = transform.scale(image.load('Backgraung.jpg'), (win_width, win_height))
...
while run:
    ...
    def two_window(Menu):
        ...
        window = display.set_mode((win_width, win_height))
        loading_text = font2.render("Щоб почати грати натисніть 1", 1, (255, 255, 255))
        time.sleep(1 else Menu == 'Щоб почати грати натисніть 1') 
